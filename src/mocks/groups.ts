...
const group1Notes: Note[] = [
  {
    ...
    content: 'Water\nSunscreen\nTrail mix\nFirst aid kit\nHat\nHiking boots',
    blocks: [
      { id: 'gb1-1', type: 'heading1', content: 'Packing List for Hikes' },
      { id: 'gb1-2', type: 'checklist', content: 'Water', checked: true },
      { id: 'gb1-3', type: 'checklist', content: 'Sunscreen', checked: true },
      { id: 'gb1-4', type: 'checklist', content: 'Trail mix', checked: false },
      { id: 'gb1-5', type: 'checklist', content: 'First aid kit', checked: false },
      { id: 'gb1-6', type: 'checklist', content: 'Hat', checked: true },
      { id: 'gb1-7', type: 'checklist', content: 'Hiking boots', checked: true },
    ],
    color: '#D4764E',
    createdBy: 'user-1',
    createdAt: new Date('2026-02-17T10:00:00'),
    updatedAt: new Date('2026-02-19T14:00:00'),
    isPrivate: false,
    isPinned: true,
    tags: ['essentials'],
  },
      ...
      itinerary: [
        {
          ...
          day: 1,
          time: '14:00',
          title: 'Pavlos & Maria arrive',
          type: 'arrival' as const,
          location: 'Narita Airport',
          travelers: [
            { userId: CURRENT_USER_ID, name: 'You' },
            { userId: 'user-4', name: 'Morgan Taylor' },
          ],
          transportMethod: 'airplane' as const,
          travelDetails: { flightNumber: 'IB1545', airline: 'Iberia', portOrStation: 'Narita Airport' },
        },
        {
          id: 'itin-2',
          day: 1,
        ...
        },
        {
          ...
          travelers: [{ userId: 'user-3', name: 'Jamie Lee' }],
          transportMethod: 'airplane' as const,
      ...
      notes: [
        {
          ...
          blocks: [
            { id: 'hb1-1', type: 'heading1' as const, content: 'WiFi Password' },
            { id: 'hb1-2', type: 'paragraph' as const, content: 'Network: Apt4B-5G\nPassword: sunnydays2026' },
          ],
          color: '#5B8EC9',
          createdBy: CURRENT_USER_ID,
        ...
        },
        {
          ...
          blocks: [
            { id: 'hb2-1', type: 'heading1' as const, content: 'Building Maintenance' },
            { id: 'hb2-2', type: 'heading2' as const, content: 'Contact' },
            { id: 'hb2-3', type: 'paragraph' as const, content: 'Mike at (415) 555-0199' },
            { id: 'hb2-4', type: 'heading2' as const, content: 'Hours' },
            { id: 'hb2-5', type: 'paragraph' as const, content: 'Mon-Fri 9am-5pm' },
            { id: 'hb2-6', type: 'heading2' as const, content: 'Emergency' },
            { id: 'hb2-7', type: 'paragraph' as const, content: '(415) 555-0100' },
          ],
          color: '#D4764E',
          createdBy: 'user-6',
